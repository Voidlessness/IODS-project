...
human_ <- filter(human, FALSE) # modify the "TRUE", see instructions above!
...
p <- ggpairs(human_, lower = list(combo = wrap("facethist", bins = 20)))
p
...
pivot_longer(tea_time, cols = everything()) %>% 
  ggplot (geom_bar(), aes(value) + facet_wrap("name", scales = "free"))
